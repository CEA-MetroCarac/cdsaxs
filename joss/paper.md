...
![Workflow of the CMA-ES algorithm in the cdsaxs package.\label{fig:workflow_cmaes}](cmaes_overall.png){width=1.05\linewidth}

The overall workflow of the MCMC algorithm:

![Workflow of the MCMC algorithm in the cdsaxs package.\label{fig:workflow_mcmc}](mcmc_overall.png){width=1.05\linewidth}
...
![Comparison of fits obtained by Xi-cam and the cdsaxs package in Fourier space. Experimental results are also plotted.\label{fig:compare_profile}](compare_xicam.png){width=1.05\linewidth}
