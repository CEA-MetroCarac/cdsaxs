...
CD-SAXS is a powerful yet emerging technique for characterization of nano-components in semiconductor industry. Efforts by the community were done to explore different combination of algorithms to model CD-SAXS data [@hannon2016advancing, @sunday2016mcmc]. However, there is a lack of open-source software for comprehensive data analysis. It currently on exist a python package inside **Xi-cam**[@Xi-cam] repository but the code is no longer maintained. While it exists proprietary tools, developement of model for CD-SAXS requires researchers to develop their own solutions for simulating and fitting CD-SAXS data. Moreover, the diversity of samples analyzed using CD-SAXS requires versatile software that can accommodate different types of models and experimental conditions.
